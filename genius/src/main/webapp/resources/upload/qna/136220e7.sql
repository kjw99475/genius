...
INSERT INTO `tbl_bbs` (`bbs_idx`, `bbs_title`, `category_code`, `member_id`, `fileYN`, `bbs_contents`, `reg_date`, `read_cnt`, `modify_date`) VALUES
	...
	(6, '제목임', 'bc01', '작성자임', NULL, '내용임', '2024-04-28 15:26:27', 0, NULL),
	(7, '테스트 제목ㅍㅇㄴ', 'bc01', '홍길동', NULL, '테서터 내용', '2024-04-28 00:00:00', 0, NULL),
	(9, '삭제용', 'bc01', '삭', NULL, '제제', '2024-04-12 00:00:00', 0, NULL);
...
INSERT INTO `tbl_book` (`book_idx`, `book_code`, `book_name`, `author`, `price`, `quantity`, `category_class_code`, `category_subject_code`, `sales_start_date`, `sales_end_date`, `sales_status`, `book_img`, `publisher`, `discount_price`, `discount_per`, `book_info`, `rank_avg`, `video`, `isbn`, `tags`, `contents`, `publication_date`) VALUES
	...
	(16, 'b0008', '초등 수학1', '교육부', 3400, 0, 'c01', 's03', NULL, NULL, '1', NULL, '천재교과서', 0, 0, '문제와 문제 사이의 연결고리, 연습과 실전 사이의 징검다리 그동안 설맞이팀이 출제했던 모든 문항에, 최신 경향을 고려한 신규문항이 추가된 110문항 수록 단순히 문제만 모아 두는 것을 넘어, 수학 학습에 도움이 되도록 설계된 든든한 길잡이', 0.0, '', '10', NULL, ',수학을 만나요, 9까지의 수,여러 가지 모양,덧셈과 뺄셈,비교하기,50까지의 수', '2024-02-15'),
	(17, 'b0015', '초등 수학익힘1', '교육부', 2130, 12, 'c01', 's03', NULL, NULL, '2', 'https://mall.chunjaetext.co.kr/web/product/small/202402/c92bb75807729444600df21b9257ccf9.jpg', '천재교과서', 3300, 0, '천재교과서에서 출판한 초등수학익힘1 입니다.', 0.0, NULL, '15151515', NULL, '1. 9까지의 수|2. 여러 가지 모양|3. 덧셈과 뺄셈|4. 비교하기|5. 50까지의 수', '2024-02-15');
...
-- 테이블 데이터 genius.tbl_delivery:~0 rows (대략적) 내보내기
INSERT INTO `tbl_delivery` (`delivery_idx`, `order_num`, `member_id`, `total_price`, `delivery_code`, `delivery_start_date`, `delivery_end_date`, `delivery_addr1`, `delivery_addr2`, `delivery_state`, `delivery_company`) VALUES
	(1, 'o00001', 'test', 5530, 'd000001', NULL, NULL, '서울시 중랑구', '테스트주소', '배송전', '우체국 택배');
...
INSERT INTO `tbl_member` (`member_idx`, `member_id`, `social_type`, `member_name`, `pwd`, `birthday`, `phone`, `gender`, `zip_code`, `addr1`, `addr2`, `point`, `profile`, `reg_date`, `admin_YN`, `modify_date`, `leave_date`, `status`, `terms1`, `terms2`, `terms3`, `terms4`, `email`) VALUES
	(1, 'test', NULL, '테스트', '1234', '1996-04-25', '0106298567', '남', '683-111', '서울시 중랑구', '테스트주소', 6400, NULL, '2024-04-25 16:06:29', 'N', NULL, '0000-00-00 00:00:00', 'Y', 'Y', 'Y', 'Y', 'Y', 'test@naver.com'),
	(2, 'test1', NULL, '테스트', '1234', '1998-06-17', '01043734547', '남', '683-111', '서울시 중랑구', '테스트주소', 0, NULL, '2024-04-26 15:21:15', 'N', NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'Y', 'test1@naver.com'),
	(3, 'test2', NULL, '테스트3', '1234', '2024-04-26', '01044444444', '남', '683-111', '서울시 중랑구', '테스트주소', 0, NULL, '2024-04-26 15:22:01', 'N', NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'Y', 'test2@naver.com'),
	(4, 'admin', NULL, '관리자', '1234', '2024-04-27', '01012341234', '여', '111-111', '서울시 동작구', '신대방 최고', 100000, NULL, '2024-04-27 22:23:51', 'Y', NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'Y', NULL),
	...
	(6, 'gee2', NULL, '장지현2', '1234', '2024-03-31', '01011112222', '남', '07067', '서울 동작구 대림로 2', '신대방역', 0, NULL, '2024-04-28 01:07:49', 'N', NULL, NULL, 'Y', 'Y', 'N', 'N', 'N', NULL),
	(7, 'mong1', NULL, '몽구리', '1234', '2024-01-10', '01012341234', '여', '07574', '서울 강서구 양천로 442', '아무데나', 0, NULL, '2024-04-28 01:15:18', 'N', NULL, NULL, 'Y', 'Y', 'Y', 'N', 'N', NULL);
...
-- 테이블 데이터 genius.tbl_order:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 genius.tbl_payment:~5 rows (대략적) 내보내기
...
-- 테이블 데이터 genius.tbl_qna:~0 rows (대략적) 내보내기
INSERT INTO `tbl_qna` (`qna_idx`, `bbs_idx`, `reply_contents`, `reg_date`, `modify_date`, `ref_idx`, `category_code`, `answerYN`, `title`) VALUES
	(1, 1, '답변입니다.', '2024-04-25 16:37:50', NULL, NULL, 'bc02', 'N', '');
...
-- 테이블 데이터 genius.tbl_release:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 genius.tbl_store:~0 rows (대략적) 내보내기
