                ...
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <!--Form -->
                            <form method="post" id="registFrm" action="/admin/announce/contentregist" enctype="multipart/form-data">
<%--                                <input type="hidden" name="bbs_idx" value="${bbsDTO.bbs_idx}">--%>
                                ...
                                <div class="d-flex text-center mt-5 justify-content-end">
                                    ...
                                    <button type="button" class="btn btn-light" onclick="location.href='/admin/announce/list'">취소</button>
                                </div>
                            </form><!-- EndForm -->
