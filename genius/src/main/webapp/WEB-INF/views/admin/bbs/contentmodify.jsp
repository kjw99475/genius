    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">자료실 수정</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                ...
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <!--Form -->
                            <form method="post" id="modifyFrm" action="/admin/bbs/contentmodify" enctype="multipart/form-data">
...
<%--                                </div>--%>
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <ul id="org-file-list" class="form-group d-flex flex-column m-0 p-0" style="gap:5px">
                                            <c:forEach items="${fileList}" var="file">
                                                <li class="card mb-1 shadow-none border border-gray d-flex flex-row justify-content-between p-2 fileListNodes"><span>${file.original_name}</span><span><a id="deleteButton" data-fileIdx="${file.file_idx}" class="text-danger font-weight-bold pr-2" href="#" onclick="deleteThisFile2(this)">X</a></span></li>
                                ...
                                <div class="d-flex text-center mt-5 justify-content-end">
                                    ...
                                    <button type="button" class="btn btn-outline-success" onclick="location.href='/admin/bbs/view?bbs_idx=${bbsDTO.bbs_idx}'">취소</button>
                                </div>
                            </form><!-- EndForm -->
