                ...
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            <div class="row">
                                                <div class="col-2">
                                                    <input class="form-check-input" type="checkbox" name="search_type" id="banner_name" checked>
                                                    <label class="form-check-label" for="banner_name">
                                                        배너 이름
                                                    </label>
                                                </div>
                                                <div class="col-2">
                                                    <input class="form-check-input" type="checkbox" name="search_type" id="banner_use">
                                                    <label class="form-check-label" for="banner_use">
                                                        사용 여부
                                                    </label>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <button type="button" class="btn btn-success"
                                                onclick="location.href='admin-bbs-banner-regist.html'">등록</button>
                                    </div>
                                </div>
                        ...
                        <table class="table " style="overflow: scroll;">
                            ...
                            <tbody>
                            <tr onclick="location.href='admin-bbs-banner-modify.html'">
