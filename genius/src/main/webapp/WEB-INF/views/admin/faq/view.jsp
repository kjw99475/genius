                ...
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <!--Form -->
                            <form method="post" id="frm_faq_delete" action="/admin/faq/delete">
                                <div class="row mb-3">
                                ...
                                <div class="text-center">
                                    <button type="button" class="btn btn-success" onclick="location.href='/admin/faq/contentmodify'">수정</button>
                                    <button type="button" class="btn btn-success" onclick="faq_delete()">삭제</button>
                                </div>
...
<script>
    const frm_delete = document.querySelector("#frm_faq_delete");
    function faq_delete() {
