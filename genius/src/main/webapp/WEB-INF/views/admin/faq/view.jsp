                ...
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <!--Form -->
                            <form method="post" id="frm_bbs_delete" action="/admin/faq/delete">
                                ...
                                <div class="mt-5 d-flex justify-content-between">
                                    <div>
                                        <button type="button" class="btn btn-outline-success" onclick="location.href='/admin/faq/list'">목록</button>
                                    </div>
                                    <div>
                                        <button type="button" class="btn btn-success me-2"
                                                onclick="location.href='/admin/faq/contentmodify?bbs_idx=${bbsDTO.bbs_idx}'">
                                            수정
                                        </button>
                            ...
                            <div class="mt-5">
                                <table class="table table-borderless text-start">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <tr class=" border-bottom mb-0" onclick="location.href='/admin/faq/view?bbs_idx='+${postbbsDTO.bbs_idx}">
                                                <td>다음글</td>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <tr onclick="location.href='/admin/faq/view?bbs_idx='+${prebbsDTO.bbs_idx}">
                                                <td>이전글</td>
