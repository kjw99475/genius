                ...
                <c:if test="${fileList ne null}">
                    <c:forEach items="${fileList}" var="file">
                        <tr>
                            ...
                            <td><button type="button" class="rounded-circle bg-lightgray btn btn-light"><i class="ti-file"></i></button> <a href="/bbs/noticeFileDownload?file_idx=${file.file_idx}&bbs_idx=${bbsDTO.bbs_idx}" >${file.original_name}</a> </td>
                        </tr>
                    </c:forEach>
                </c:if>
                <tr>
