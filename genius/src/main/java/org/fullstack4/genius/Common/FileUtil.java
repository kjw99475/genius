...
public class FileUtil {
    ...
    public static void FileUpload(MultipartFile file,String directory) {
    ...
    public static void MultiFileUpload(List<MultipartFile> list, MultipartHttpServletRequest files,String directory) {
        String uploadFolder = directory;
